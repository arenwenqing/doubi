    ...
    <Mask visible={detailModal.visible} opacity={0.8}>
      <div className='detail-description-content'>
        ...
        <ul className='detail-description-ul'>
          <li>1. 不同的盲盒内产出的礼物不同。</li>
          <li>2. 不同类型的盲盒仅可使用对应的钥匙开启，如“银光盲盒”仅可使用“银钥匙”开启。</li>
          <li>3. 所有盲盒均有机会产出至尊礼物，至尊大奖包含“嘉年华”、“糖果飞船”、“火箭。</li>
          <li>4. 您获得的礼物，将在您确认提取后，以抖币的形式进入到您指定的账户中。</li>
          <li>5. 每一种盲盒在 80 次开启内必出至少 1 件金色礼物。</li>
          <li>6. 金色礼物分别为：铜质盲盒【“爱的守护”、“墨镜”】，银光盲盒【“保时捷”、“真
的爱你”】，金闪盲盒【“Disco”、“私人飞机”】。</li>
